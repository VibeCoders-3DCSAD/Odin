...
export default function DebtCreateScreen({ userId, deviceId, onBack, onSaved }: Props) {
  ...
  return <View style={{ gap: 14 }}>
    <View>
     ...
     {manager.showCreate ? <DebtForm editingId={null} name={manager.name} lenderName={manager.lenderName} originalBalance={manager.originalBalance} balance={manager.balance} startDate={manager.startDate} fees={manager.fees} penalties={manager.penalties} interestRate={manager.interestRate} minimum={manager.minimum} paymentFrequency={manager.paymentFrequency} paymentSchedule={manager.paymentSchedule} nextDueDate={manager.nextDueDate} maturityDate={manager.maturityDate} targetPayoffDate={manager.targetPayoffDate} interestPeriod={manager.interestPeriod} interestMethod={manager.interestMethod} notes={manager.notes} presetKey={manager.presetKey} presetData={manager.presetData} formError={manager.formError} pending={manager.pendingIds.has("new")} setName={manager.setName} setLenderName={manager.setLenderName} setOriginalBalance={manager.setOriginalBalance} setBalance={manager.setBalance} setStartDate={manager.setStartDate} setFees={manager.setFees} setPenalties={manager.setPenalties} setInterestRate={manager.setInterestRate} setMinimum={manager.setMinimum} setPaymentFrequency={manager.setPaymentFrequency} setPaymentSchedule={manager.setPaymentSchedule} setNextDueDate={manager.setNextDueDate} setMaturityDate={manager.setMaturityDate} setTargetPayoffDate={manager.setTargetPayoffDate} setInterestPeriod={manager.setInterestPeriod} setInterestMethod={manager.setInterestMethod} setNotes={manager.setNotes} setPresetKey={manager.setPresetKey} setPresetData={manager.setPresetData} onCancel={onBack} onSave={() => void save()} /> : null}
