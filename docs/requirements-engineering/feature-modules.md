...
- [Odin Feature Modules](#odin-feature-modules)
- [1. User Authentication](#1-user-authentication)
  - [1.1 Account Access](#11-account-access)
  - [1.2 Authentication Forms](#12-authentication-forms)
  - [1.3 Authentication States](#13-authentication-states)
  - [1.4 Authentication Validation](#14-authentication-validation)
  - [1.5 Authentication Messages](#15-authentication-messages)
    - [Validation Messages](#validation-messages)
    - [Authentication Error Messages](#authentication-error-messages)
    - [Network and Session Error Messages](#network-and-session-error-messages)
    - [Verification and Password Recovery Messages](#verification-and-password-recovery-messages)
    - [Authentication Progress and Success Messages](#authentication-progress-and-success-messages)
- [2. Onboarding Questionnaire](#2-onboarding-questionnaire)
  - [2.1 Guided Onboarding](#21-guided-onboarding)
  - [2.2 Questionnaire Inputs](#22-questionnaire-inputs)
  - [2.3 Questionnaire Validation](#23-questionnaire-validation)
  - [2.4 Questionnaire Empty States](#24-questionnaire-empty-states)
  - [2.5 Questionnaire States](#25-questionnaire-states)
  - [2.6 Questionnaire Messages](#26-questionnaire-messages)
    - [Validation Messages](#validation-messages)
    - [Onboarding Error Messages](#onboarding-error-messages)
    - [Onboarding Notices](#onboarding-notices)
  - [2.7 Financial Profile](#27-financial-profile)
- [3. Dashboard](#3-dashboard)
  - [3.1 Financial Overview](#31-financial-overview)
  - [3.2 Personal Finance Summary](#32-personal-finance-summary)
  - [3.3 Dashboard Empty States](#33-dashboard-empty-states)
  - [3.4 Dashboard States](#34-dashboard-states)
  - [3.5 Dashboard Messages](#35-dashboard-messages)
    - [Dashboard Error Messages](#dashboard-error-messages)
    - [Dashboard Notice Messages](#dashboard-notice-messages)
    - [Dashboard Progress and Success Messages](#dashboard-progress-and-success-messages)
  - [3.6 Budget Health States](#36-budget-health-states)
  - [3.7 Dashboard Calculations](#37-dashboard-calculations)
- [4. Financial Accounts](#4-financial-accounts)
  - [4.1 Account Management](#41-account-management)
  - [4.2 Account Form](#42-account-form)
  - [4.3 Account Form Placeholders](#43-account-form-placeholders)
  - [4.4 Account States](#44-account-states)
  - [4.5 Account Messages](#45-account-messages)
    - [Validation Messages](#validation-messages)
    - [Account Error Messages](#account-error-messages)
    - [Account Notices](#account-notices)
    - [Account Progress and Success Messages](#account-progress-and-success-messages)
  - [4.6 Account Validation and Calculations](#46-account-validation-and-calculations)
- [5. Income Sources](#5-income-sources)
  - [5.1 Income Source Overview](#51-income-source-overview)
  - [5.2 Create Income Source](#52-create-income-source)
  - [5.3 Edit Income Source](#53-edit-income-source)
  - [5.4 Delete Income Source](#54-delete-income-source)
  - [5.5 Income Source Form](#55-income-source-form)
  - [5.6 Income Calculations](#56-income-calculations)
  - [5.7 Income Scheduling and Automation](#57-income-scheduling-and-automation)
  - [5.8 Income Source States](#58-income-source-states)
  - [5.9 Income Source Messages](#59-income-source-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Network and Session Error Messages](#network-and-session-error-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
    - [Recovery Messages](#recovery-messages)
- [6. Budgeting Module](#6-budgeting-module)
  - [6.1 Budget Overview](#61-budget-overview)
  - [6.2 Create Budget](#62-create-budget)
  - [6.3 Edit Budget](#63-edit-budget)
  - [6.4 Delete Budget](#64-delete-budget)
  - [6.5 Budget Planning](#65-budget-planning)
  - [6.6 Budget Form](#66-budget-form)
  - [6.7 Budget Form Placeholders](#67-budget-form-placeholders)
  - [6.8 Budget Form Validation](#68-budget-form-validation)
  - [6.9 Budget States](#69-budget-states)
  - [6.10 Budget Messages](#610-budget-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
    - [Recovery Messages](#recovery-messages)
  - [6.11 Budget Calculations](#611-budget-calculations)
  - [6.12 Budget Tracking](#612-budget-tracking)
  - [6.13 Budget Optimization](#613-budget-optimization)
  - [6.14 Budget Optimizer Form](#614-budget-optimizer-form)
  - [6.15 Budget Optimizer States](#615-budget-optimizer-states)
  - [6.16 Budget Optimizer Messages](#616-budget-optimizer-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Recovery Messages](#recovery-messages)
  - [6.17 Budget Optimizer Validation](#617-budget-optimizer-validation)
- [7. Debt Management](#7-debt-management)
  - [7.1 Debt Overview](#71-debt-overview)
  - [7.2 Credit Card Module](#72-credit-card-module)
  - [7.3 Credit Card Account Form](#73-credit-card-account-form)
  - [7.3.1 Credit Card Account Form Placeholders](#731-credit-card-account-form-placeholders)
  - [7.3.2 Credit Card Account Validation](#732-credit-card-account-validation)
  - [7.4 Credit Card Billing Cycles](#74-credit-card-billing-cycles)
  - [7.4.1 Credit Card Billing Cycle Form](#741-credit-card-billing-cycle-form)
  - [7.4.2 Credit Card Billing Cycle Form Placeholders](#742-credit-card-billing-cycle-form-placeholders)
  - [7.4.3 Credit Card Billing Cycle Validation](#743-credit-card-billing-cycle-validation)
  - [7.5 Credit Card Transactions and Installments](#75-credit-card-transactions-and-installments)
  - [7.5.1 Credit Card Transaction Form](#751-credit-card-transaction-form)
  - [7.5.2 Credit Card Transaction Form Placeholders](#752-credit-card-transaction-form-placeholders)
  - [7.5.3 Credit Card Transaction Validation](#753-credit-card-transaction-validation)
  - [7.5.4 Credit Card Installment Form](#754-credit-card-installment-form)
  - [7.5.5 Credit Card Installment Form Placeholders](#755-credit-card-installment-form-placeholders)
  - [7.5.6 Credit Card Installment Validation](#756-credit-card-installment-validation)
  - [7.6 Credit Card Statements](#76-credit-card-statements)
  - [7.6.1 Credit Card Statement Form](#761-credit-card-statement-form)
  - [7.6.2 Credit Card Statement Form Placeholders](#762-credit-card-statement-form-placeholders)
  - [7.6.3 Credit Card Statement Validation](#763-credit-card-statement-validation)
  - [7.7 Credit Card Payments and Credit Balances](#77-credit-card-payments-and-credit-balances)
  - [7.7.1 Credit Card Payment Form](#771-credit-card-payment-form)
  - [7.7.2 Credit Card Payment Form Placeholders](#772-credit-card-payment-form-placeholders)
  - [7.7.3 Credit Card Payment Validation](#773-credit-card-payment-validation)
  - [7.7.4 Credit Card Early Settlement Form](#774-credit-card-early-settlement-form)
  - [7.7.5 Credit Card Early Settlement Form Placeholders](#775-credit-card-early-settlement-form-placeholders)
  - [7.7.6 Credit Card Early Settlement Validation](#776-credit-card-early-settlement-validation)
  - [7.8 Credit Card Budgeting](#78-credit-card-budgeting)
  - [7.8.1 Credit Card Repayment Strategy Form](#781-credit-card-repayment-strategy-form)
  - [7.8.2 Credit Card Repayment Strategy Placeholders](#782-credit-card-repayment-strategy-placeholders)
  - [7.8.3 Credit Card Repayment Strategy Validation](#783-credit-card-repayment-strategy-validation)
  - [7.8.4 Credit Card States](#784-credit-card-states)
  - [7.8.5 Credit Card Messages](#785-credit-card-messages)
    - [Validation Messages](#validation-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Error and Recovery Messages](#error-and-recovery-messages)
    - [Confirmation Messages](#confirmation-messages)
  - [7.8.6 Credit Card Scope Boundaries](#786-credit-card-scope-boundaries)
  - [7.9 Non-Credit-Card Debt Management](#79-non-credit-card-debt-management)
  - [7.10 Non-Credit-Card Debt Status and Progress](#710-non-credit-card-debt-status-and-progress)
  - [7.10.1 Non-Credit-Card Debt Repayment Forecast](#7101-non-credit-card-debt-repayment-forecast)
  - [7.11 Transaction-Triggered Debt Recording](#711-transaction-triggered-debt-recording)
  - [7.12 Non-Credit-Card Debt Payment Transaction Flow](#712-non-credit-card-debt-payment-transaction-flow)
  - [7.13 Non-Credit-Card Debt Form](#713-non-credit-card-debt-form)
  - [7.14 Non-Credit-Card Debt Type Selection](#714-non-credit-card-debt-type-selection)
  - [7.15 Non-Credit-Card Debt Form Placeholders](#715-non-credit-card-debt-form-placeholders)
  - [7.15.1 Non-Credit-Card Debt Type-Specific Placeholders](#7151-non-credit-card-debt-type-specific-placeholders)
  - [7.16 Debt Strategy Selection](#716-debt-strategy-selection)
  - [7.17 Non-Credit-Card Debt Payment Form](#717-non-credit-card-debt-payment-form)
  - [7.18 Non-Credit-Card Debt Payment Form Placeholders](#718-non-credit-card-debt-payment-form-placeholders)
  - [7.19 Non-Credit-Card Debt Payment Validation](#719-non-credit-card-debt-payment-validation)
  - [7.20 Non-Credit-Card Debt Payment States](#720-non-credit-card-debt-payment-states)
  - [7.21 Non-Credit-Card Debt Payment Messages](#721-non-credit-card-debt-payment-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
    - [Recovery Messages](#recovery-messages)
  - [7.22 Non-Credit-Card Debt Type-Specific Inputs](#722-non-credit-card-debt-type-specific-inputs)
  - [7.23 Non-Credit-Card Debt Form Validation](#723-non-credit-card-debt-form-validation)
  - [7.24 Non-Credit-Card Debt States](#724-non-credit-card-debt-states)
  - [7.25 Non-Credit-Card Debt Messages](#725-non-credit-card-debt-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
    - [Recovery Messages](#recovery-messages)
  - [7.26 Debt Calculations](#726-debt-calculations)
- [8. Savings Goals Module](#8-savings-goals-module)
  - [8.1 Savings Overview](#81-savings-overview)
  - [8.2 Savings Goal Management](#82-savings-goal-management)
  - [8.3 Savings Goal Creation Form](#83-savings-goal-creation-form)
  - [8.4 Savings Goal Form Placeholders](#84-savings-goal-form-placeholders)
  ...
  - [8.7 Savings Activity Transaction Context](#87-savings-activity-transaction-context)
  - [8.8 Savings Activity Context Placeholders](#88-savings-activity-context-placeholders)
  - [8.9 Savings Validation](#89-savings-validation)
  - [8.10 Savings Calculations](#810-savings-calculations)
  - [8.11 Savings Allocation](#811-savings-allocation)
  - [8.12 Savings Allocation Rules](#812-savings-allocation-rules)
  - [8.13 Savings Projections](#813-savings-projections)
  - [8.14 Savings Projection Inputs](#814-savings-projection-inputs)
  - [8.15 Savings Reminders and Alerts](#815-savings-reminders-and-alerts)
  - [8.16 Savings States](#816-savings-states)
  - [8.17 Savings Messages](#817-savings-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
...
- [9. Settings Module](#9-settings-module)
  - [9.1 Account and Profile](#91-account-and-profile)
  - [9.2 Settings Forms](#92-settings-forms)
  - [9.3 Settings Form Placeholders](#93-settings-form-placeholders)
  - [9.4 Settings Selectors](#94-settings-selectors)
  - [9.5 Settings Validation](#95-settings-validation)
  - [9.6 Privacy and Consent](#96-privacy-and-consent)
  - [9.7 Notification Preferences](#97-notification-preferences)
  - [9.8 Data and Account Governance](#98-data-and-account-governance)
  - [9.9 Sync and Connectivity](#99-sync-and-connectivity)
  - [9.10 Help and About](#910-help-and-about)
  - [9.11 Settings States](#911-settings-states)
  - [9.12 Settings Messages](#912-settings-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
    - [Recovery Messages](#recovery-messages)
- [10. Categories and Restrictions Module](#10-categories-and-restrictions-module)
  - [10.1 Category Taxonomy](#101-category-taxonomy)
  - [10.2 Category Forms](#102-category-forms)
  - [10.3 Category Form Placeholders](#103-category-form-placeholders)
  - [10.4 Category Selectors](#104-category-selectors)
  - [10.5 Category Validation](#105-category-validation)
  - [10.6 Category Context and Restrictions](#106-category-context-and-restrictions)
  - [10.7 Restriction Rules](#107-restriction-rules)
  - [10.8 Category States](#108-category-states)
  - [10.9 Category Messages](#109-category-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
- [11. Financial Obligations Module](#11-financial-obligations-module)
  - [11.1 Obligation Management](#111-obligation-management)
  - [11.2 Obligation Form](#112-obligation-form)
  - [11.3 Obligation Form Placeholders](#113-obligation-form-placeholders)
  - [11.4 Obligation Selectors](#114-obligation-selectors)
  - [11.5 Obligation Payment Form](#115-obligation-payment-form)
  - [11.6 Obligation Payment Form Placeholders](#116-obligation-payment-form-placeholders)
  - [11.7 Obligation Validation](#117-obligation-validation)
  - [11.8 Obligation Calculations and Rules](#118-obligation-calculations-and-rules)
  - [11.9 Obligation States](#119-obligation-states)
  - [11.10 Obligation Messages](#1110-obligation-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
  - [11.11 Obligation Automation](#1111-obligation-automation)
- [12. Transaction Management Module](#12-transaction-management-module)
  - [12.1 Transaction Entry](#121-transaction-entry)
  - [12.2 Transaction Form](#122-transaction-form)
  - [12.3 Transaction Form Placeholders](#123-transaction-form-placeholders)
  - [12.4 Transaction Selectors](#124-transaction-selectors)
  - [12.5 Transaction Validation](#125-transaction-validation)
  - [12.6 Credit Card Transaction Flow](#126-credit-card-transaction-flow)
  - [12.7 Savings Contribution Transaction Flow](#127-savings-contribution-transaction-flow)
  - [12.8 Contribution Transaction Flow](#128-contribution-transaction-flow)
  - [12.8.1 Savings Withdrawal Transaction Flow](#1281-savings-withdrawal-transaction-flow)
  - [12.9 Debt Payment Transaction Flow](#129-debt-payment-transaction-flow)
  - [12.9.1 Credit Card Statement Payment Transaction Flow](#1291-credit-card-statement-payment-transaction-flow)
  - [12.10 Obligation Payment Transaction Flow](#1210-obligation-payment-transaction-flow)
  - [12.11 Transaction History](#1211-transaction-history)
  - [12.12 Transaction Search and Review](#1212-transaction-search-and-review)
  - [12.13 Transaction Changes](#1213-transaction-changes)
  - [12.14 Recurring Transactions](#1214-recurring-transactions)
  - [12.15 Transaction Calculations](#1215-transaction-calculations)
  - [12.16 Transaction States](#1216-transaction-states)
  - [12.17 Transaction Messages](#1217-transaction-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
    - [Recovery Messages](#recovery-messages)
- [13. Alerts and Notifications Module](#13-alerts-and-notifications-module)
  - [13.1 Alert Inbox](#131-alert-inbox)
  - [13.2 Alert Actions](#132-alert-actions)
  - [13.3 Alert Sources](#133-alert-sources)
  - [13.4 Alert States](#134-alert-states)
  - [13.5 Alert Messages](#135-alert-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
    - [Confirmation Messages](#confirmation-messages)
- [14. Forecasting and Financial Intelligence Module](#14-forecasting-and-financial-intelligence-module)
  - [14.1 Forecasting](#141-forecasting)
  - [14.2 Forecast Trust Information](#142-forecast-trust-information)
  - [14.3 Anomaly and Overspending Detection](#143-anomaly-and-overspending-detection)
  - [14.4 Forecasting States](#144-forecasting-states)
  - [14.5 Forecasting and Intelligence Messages](#145-forecasting-and-intelligence-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
- [15. Reports and Analytics Module](#15-reports-and-analytics-module)
  - [15.1 Report Creation](#151-report-creation)
  - [15.2 Report Content](#152-report-content)
  - [15.3 Report Presentation](#153-report-presentation)
  - [15.4 Report Filters](#154-report-filters)
  - [15.5 Report Calculations](#155-report-calculations)
  - [15.6 Report States](#156-report-states)
  - [15.7 Report Messages](#157-report-messages)
    - [Validation Messages](#validation-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
- [16. Offline Sync and Recovery Module](#16-offline-sync-and-recovery-module)
  - [16.1 Sync Visibility](#161-sync-visibility)
  - [16.2 Sync Recovery](#162-sync-recovery)
  - [16.3 Account Safety](#163-account-safety)
  - [16.4 Sync States](#164-sync-states)
  - [16.5 Offline Sync and Recovery Messages](#165-offline-sync-and-recovery-messages)
    - [Error Messages](#error-messages)
    - [Notice Messages](#notice-messages)
    - [Progress and Success Messages](#progress-and-success-messages)
