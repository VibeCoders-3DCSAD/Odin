...
-- Verification status: SYNTAX-VERIFIED (pgsql-parser / libpg_query 16). Analysis-resolved.
-- NOT YET EXECUTED. This draft has not yet been run as a Supabase/PostgreSQL
-- migration. Execute it against a Supabase project or local PostgreSQL instance
